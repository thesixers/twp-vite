    ...
    <div class="max-w-[320px] w-full bg-white rounded-md duration-300 overflow-hidden border-none">
      <Link to="/read" state={{ webtoonData, currentEpisode }}>
        ...
        <div class="p-2 flex flex-col gap-2">
          <div className="text-md font-semibold text-gray-800 hover:text-orange-600 transition-colors duration-300 line-clamp-1">{title}</div>
          <div class="flex items-center justify-between text-sm text-gray-500">
            <span class="font-medium text-sm text-orange-500">{releaseDate}</span>
            {diffDays <= 21 && (
