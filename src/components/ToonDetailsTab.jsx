...
export default function ToonDetailsTab({likeCount, isLiked, details:{author, illustrators, releaseDate, genre, description }}) {
  return (
    <div className="details space-y-6 animate-fadeIn text-center md:text-left">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-5">
            ...
            <p className="text-gray-800 text-base">{illustrators}</p>
            </div>
            ...
            <div>
            <h3 className="text-sm font-semibold text-gray-500 mb-1">{releaseDate}</h3>
            <p className="text-gray-800 text-base ">Sat Mar 08 2025</p>
            </div>
        </div>
